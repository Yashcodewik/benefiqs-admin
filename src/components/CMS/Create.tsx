...
const initialContent = `
  <h2>Start writing your Benefiqs update</h2>
  <p>Use this space to create announcements, benefit guides, partner updates, and member-facing content.</p>
`;
...
export default function CreateCMSComponent() {
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-white font-bold text-xl">Add CMS Content</h2>
            <p className="text-text-muted text-sm mt-0.5">Create a new article with the Tiptap editor.</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <button
          ...
          >
            <RiSave3Line className="text-base" /> {saving ? "Creating..." : "Create"}
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_320px] gap-6">
        ...
        <aside className="bg-surface border border-border-color rounded-2xl p-5 shadow-card h-fit">
          <h3 className="text-white font-semibold text-sm">Article Summary</h3>
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="text-teal font-semibold">Create</span>
            </div>
          </div>
        </aside>
      </div>
